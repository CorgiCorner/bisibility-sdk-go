	...
	tests := []resourceMethodTestCase{
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.ListRankedKeywordSuggestions(ctx, "prj spaced", &ListRankedKeywordSuggestionsOptions{
					ConnectionID: "conn 1",
					Fresh:        true,
					Limit:        100,
					Offset:       100,
			...
			path:   "/api/v1/projects/prj%20spaced/ranked-keyword-suggestions",
			query:  "connection_id=conn+1&fresh=true&limit=100&offset=100",
			response: map[string]any{
				"cached":      true,
				"connections": []any{map[string]any{"id": "conn_1", "label": "DataForSEO", "provider": "dataforseo"}},
				"cost_cents":  2.0,
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.ResearchKeywords(ctx, "prj spaced", ResearchKeywordsOptions{
					ConnectionID:       "conn 1",
					Fresh:              true,
			...
			method: http.MethodGet,
			path:   "/api/v1/projects/prj%20spaced/keyword-research",
			query:  "connection_id=conn+1&fresh=true&include_clickstream=true&max_cost_cents=5&mode=auto&result_limit=300&seed=rank+tracker",
			response: map[string]any{
				"cached":      false,
				"connections": []any{map[string]any{"id": "conn_1", "label": "DataForSEO", "provider": "dataforseo"}},
				"cost_cents":  2.0,
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.ResearchKeywords(ctx, "prj_1", ResearchKeywordsOptions{
					EstimateOnly: true,
					Mode:         KeywordResearchModeAuto,
					ResultLimit:  100,
					Seed:         "rank tracker",
			...
			method: http.MethodGet,
			path:   "/api/v1/projects/prj_1/keyword-research",
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.GetKeywordMetrics(ctx, "prj_1", GetKeywordMetricsInput{
					ConnectionID:       "conn_1",
					Fresh:              true,
					IncludeClickstream: true,
			...
			path:            "/api/v1/projects/prj_1/keyword-metrics",
			body:            `{"connection_id":"conn_1","fresh":true,"include_clickstream":true,"keywords":["rank tracker","seo api"],"max_cost_cents":5}`,
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.UpdateTeamMemberRole(ctx, "prj_1", "member 1", UpdateTeamMemberRoleInput{Role: TeamRoleAdmin})
			},
			method:          http.MethodPatch,
			path:            "/api/v1/projects/prj_1/team/members/member%201",
			body:            `{"role":"admin"}`,
			response:        TeamMemberRoleResult{ID: "member_1", Role: TeamRoleAdmin},
			wantContentType: true,
			want: func(t *testing.T, got any) {
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.RemoveTeamMember(ctx, "prj_1", "member_1")
			},
			method:   http.MethodDelete,
			path:     "/api/v1/projects/prj_1/team/members/member_1",
			response: TeamMemberMutationResult{ID: "member_1"},
			want: func(t *testing.T, got any) {
				assertEqual(t, got.(*TeamMemberMutationResult).ID, "member_1")
			},
		},
		{
			name: "resend team invite",
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.ResendTeamInvite(ctx, "prj_1", "invite_1")
			},
			method: http.MethodPost,
			path:   "/api/v1/projects/prj_1/team/invites/invite_1/resend",
			response: map[string]any{
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.ListTrafficSnapshots(ctx, "prj_1", ListTrafficSnapshotsOptions{
					EndDate:   "2026-06-30",
					Limit:     50,
					Offset:    20,
			...
			method: http.MethodGet,
			path:   "/api/v1/projects/prj_1/analytics/traffic-snapshots",
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.ListSearchPerformanceQueryStats(ctx, "prj_1", ListSearchPerformanceQueryStatsOptions{
			...
			method: http.MethodGet,
			path:   "/api/v1/projects/prj_1/analytics/query-stats",
			query:  "connection_id=conn_gsc&end_date=2026-06-30&limit=100&query=rank+tracker&start_date=2026-06-01",
			response: map[string]any{
				"connection": map[string]any{"id": "conn_gsc", "label": "Search Console", "provider": "gsc"},
				"rows": []any{map[string]any{
					"clicks":      12,
					"ctr":         0.15,
					"impressions": 80,
		...
		},
		{
			...
			call: func(ctx context.Context, c *Client) (any, error) {
				return c.SyncProjectTraffic(ctx, "prj_1", WithIdempotencyKey("sync_1"))
			},
			method:         http.MethodPost,
			path:           "/api/v1/projects/prj_1/analytics/sync",
